package DSA.MasterClass.List.CircularSinglyLinkedList;

public class CircularSinglyLinkedListWithMain {
	public static void main(String[] args) {
		...
		System.out.println(">");
		csll.insertCSLL(23, 2);
		csll.insertCSLL(44, 3);
		// System.out.println(csll.head.next.value);
...
class CircularSinglyLinkedList {
	...
	public void deleteEntireCSLL() {
		...
		System.out.println("Full List deleted !");
	}
}
